...
def main(argv):
    ...
    parser.add_argument('--hidden_size',type=int,default=-1,help='size of the hidden layer. A value<=0 means that it will be set to the size of the input layer')
